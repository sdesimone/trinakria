  ...
  <div class="badges">
    <div class="container text-center text-muted">
      <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/deed.es_ES" target="_blank" title="Zágara Travel de Trinakria Tour está bajo una licencia Creative Commons."><img alt="Licencia de Creative Commons" style="border-width:0" src="<?php bloginfo('template_directory'); ?>/img/b-cc.png" /></a><p class="visible-xs">
          <span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">ZágaraTravel</span> <!--de <a xmlns:cc="http://creativecommons.org/ns#" href="http://www.zagaratravel.com" property="cc:attributionName" rel="cc:attributionURL">Trinakria Tours</a> --> bajo una licencia <a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons</a>. </p>
	...
	<a href="http://www.lonelyplanet.es/" target="_blank" title="Web recomendada por Lonely Planet en la Guía de Sicilia. De 2008 en adelante."><img src="<?php bloginfo('template_directory'); ?>/img/b-lonely.png"> <p class="visible-xs">
          Web recomendada por Lonely Planet</p></a> </div>

<small class="pull-right hidden-xs">
<strong>TRINAKRIA TOURS SL - B64429947</strong><br/>
...
Folio 0106, Hoja/Dup 342825<br/>
  ...
  <div class="bottom">
    <div class="container text-muted">
      ...
      <p>&copy; <?php echo date('Y'); ?> Zagaratravel.com | <a href="<?php echo site_url(); ?>/condiciones/">Condiciones de Contratación</a> | <a href="<?php echo site_url(); ?>/contactar/">Contacta con nosotros</a> | <a href="<?php echo site_url(); ?>/sitemap/">Mapa Web</a> | <a href="mailto:info@zagaratravel.com">info@zagaratravel.com</a></p>     
    </div>
  </div>
</footer>
<!-- /.footer--> 
...
<script src="<?php bloginfo('template_directory'); ?>/js/affix.js"></script> 
<!--<script src="<?php bloginfo('template_directory'); ?>/js/datepicker/js/bootstrap-datepicker.js"></script>
<script src="<?php bloginfo('template_directory'); ?>/js/datepicker/js/bootstrap-datepicker.es.js"></script> --> 
