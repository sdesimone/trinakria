...
<p><strong><a href="<?php bloginfo('template_directory'); ?>/inc/precios/puglia-con-encanto.php" onclick="window.open('<?php bloginfo('template_directory'); ?>/inc/precios/puglia-con-encanto.php','popup','width=500,height=500,scrollbars=yes,resizable=yes,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false">
...
onclick="window.open('<?php bloginfo('template_directory'); ?>/inc/precios/puglia-con-encanto.php','popup','width=500,height=500,scrollbars=yes,resizable=yes,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false">
