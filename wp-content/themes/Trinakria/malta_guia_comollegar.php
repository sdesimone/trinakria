<?php 
/* Template Name: Guia Malta ComoLlegar */
get_header();
$destino="Malta";
?>
...
<img src="<?php bloginfo('template_directory'); ?>/img/malta/guia/comollegar/autobús vintage Gozo.JPG" class="img-rounded img-responsive"/>
	...
	<div class="col-md-4 col-sm-4">
	<img src="<?php bloginfo('template_directory'); ?>/img/malta/guia/comollegar/como llegar.JPG" class="img-rounded img-responsive"/>
	</div>
  </div>
...
<br/>
  <div class="row">
	<div class="col-md-4 col-sm-4">
	<img src="<?php bloginfo('template_directory'); ?>/img/malta/guia/comollegar/Gondolas Malta.JPG" class="img-rounded img-responsive"/>
	</div>
	<div class="col-md-4 col-sm-4">
	<img src="<?php bloginfo('template_directory'); ?>/img/malta/guia/comollegar/típico barco maltés.JPG" class="img-rounded img-responsive"/>
	</div>
  </div>
</div>
