  ...
  <div class="container shadow">
    <div class="row">
	  ...
	  <?php 
	    ...
	    <div class="panel-body"><?php echo $faq_answers[$nfaq]; ?></div>
            </div>
          </div>
          <?php } ?>
        </div>
